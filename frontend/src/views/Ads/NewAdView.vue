    ...
    <v-container>
        <v-row>
            <v-col cols="8" offset="2">
                ...
                <v-row>
                    <v-col cols="8">
                        <img src="https://img2.akspic.ru/previews/4/6/7/5/6/165764/165764-zvezdnye_vojny-dart_vejder-lyuk_skajuoker-dzhedaj-atmosfera-550x310.jpg" height="150" class="mt-3" />
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="8">
